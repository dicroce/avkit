...
yuv420p_to_bgra::yuv420p_to_bgra() :
    _rgb24(),
...
yuv420p_to_bgra::~yuv420p_to_bgra() throw()
{
    _destroy_scaler();
}

void yuv420p_to_bgra::transform( shared_ptr<av_packet> input, size_t width, size_t height )
{
...
shared_ptr<av_packet> yuv420p_to_bgra::get()
{
    return std::move( _rgb24 );
}

void yuv420p_to_bgra::_init_scaler( uint16_t width, uint16_t height )
{
...
void yuv420p_to_bgra::_destroy_scaler()
{
    if( _scaler )
    {
